...
**Wichtig für Commits:**
Dieses Projekt nutzt [Semantic Release](https://semantic-release.gitbook.io/) für die vollautomatische Versionierung und Changelog-Generierung. Commits müssen zwingend den **Conventional Commits** Standards (z. B. `feat: ...`, `fix: ...`, `chore: ...`) entsprechen.

*Hinweis: Neue Features oder Bugfixes werden nur akzeptiert, wenn der Mutation Score bei 100% bleibt und ein Architecture Decision Record (ADR) für architektonische Änderungen vorliegt.*
