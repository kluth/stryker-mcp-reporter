...
3. **Risk Scoring System**: Assigns a risk level (LOW, MEDIUM, HIGH, CRITICAL) to files based on how many mutants survived and whether the file contains sensitive keywords (like `auth`, `security`, `crypto`, etc.).
