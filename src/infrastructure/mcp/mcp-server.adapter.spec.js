...
describe("McpServerAdapter", () => {
    ...
    it("sollte ein err-Result zurückgeben, wenn der Port bereits belegt ist", async () => {
        ...
        await new Promise((resolve) => blocker.listen(3001, resolve));
    ...
    it("sollte die MCP-Ressourcen-Handler korrekt registrieren, Fallbacks nutzen und Werte ausliefern", async () => {
        ...
        expect(listResult.resources[0].description).toBe("Der vollständige Stryker Mutation Testing Report.");
        ...
        await expect(readHandler(invalidRequest, {})).rejects.toThrow("Ressource nicht gefunden");
    });
});
